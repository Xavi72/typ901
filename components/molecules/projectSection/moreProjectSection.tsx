...
const MoreProjectSection = ({ dict }: { dict: any }) => {
  ...
  return (
    <div className="flex flex-col w-full h-auto relative">
            ...
            >
              ...
              <div className="flex flex-col w-full sm:w-1/5 h-1/5 sm:h-full p-4 gap-8">
                ...
                <p className="text-black text-xs sm:text-sm font-semibold">
                  Porsche {selectedProject?.model} -{" "}
                  {selectedProject?.model_year}
                </p>
      ...
      <div className="flex w-full h-auto my-4 justify-end">
        <button
          className={`
        ...
        >
          {showMoreProjects
            ? dict?.restorations?.past_projects.less_button
            : dict?.restorations?.past_projects.more_button}
        </button>
      </div>
      <div
        className={`
